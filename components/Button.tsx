...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-blue-600 text-white hover:bg-blue-700 focus:ring-blue-500 shadow-sm dark:bg-blue-600 dark:hover:bg-blue-500 dark:focus:ring-blue-400",
    ...
    danger: "bg-red-600 text-white hover:bg-red-700 focus:ring-red-500 shadow-sm dark:focus:ring-red-400",
